        ...
        <div className="pt-16 ">
          ...
          <div className={outfit.className}>
            <p className="max-w-[34rem] pt-8 text-gray-500">
              * Imagina si tu diente pudiera ir a un spa. Bueno, nuestra app de
              cuidado dental es la forma más cercana de hacerlo sentir mimado.
              Reserva citas con especialistas en un abrir y cerrar de ojos, y
              trata a tus dientes con el cariño que se merecen.
            </p>
          </div>
        </div>
      </div>
